...
import { Category_Components } from "./types/category_components";
  ...
  default: [
    {
      ...
      content:
        "Thank you for using AIoT Health, you can use this app to understand yourself healthier every day.",
    },
    {
      id: 2,
      image: logo,
      title: "Works quickly in about 5 seconds.",
      content: "Tell me more about what you want to improve your health.",
    },
  ],
});
